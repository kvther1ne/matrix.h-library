...
START_TEST(inverse_det_zero) {
  ...
  int code = s21_inverse_matrix(&A, &R);
...
int main(void) {
  ...
  tcase_add_test(tc1_1, eq_test_null);
  tcase_add_test(tc1_1, test_normal);
  tcase_add_test(tc1_1, test_not_sqare);
  tcase_add_test(tc1_1, null_inverse);
  tcase_add_test(tc1_1, inverse_matrix_one);
  tcase_add_test(tc1_1, inverse_det_zero);
